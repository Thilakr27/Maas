...
<head>
    ...
    <link rel="stylesheet" href="formal shirts.css">
...
$ret=mysqli_query($con,"SELECT * FROM backend where id=2");
    ...
    <main class="Desktop">
        <section id="formal shirts">
            <section class="first-page">
                ...
                <div>
                    <img class="fir-pic" src="uploads/<?php echo $res1->image11 ?>" alt="">
                </div>
                ...
                <div class="sec-bg">
                    <img class="sec-bg-pic" src="uploads/<?php echo $res1->image12 ?>" alt="">
            ...
            <div class="main-container">
                ...
                <div class="rectangle-4a">
                  ...
                  <div class="flex-row-eb">
                    ...
                    ><a href="./t shirts.html" class="shirts">Shirts</a>
                  </div>
                ...
                <div class="flex-row-c">
                  <div class="rectangle-54">
                    ...
                    <span class="school-uniform-57"><?php echo $res->header->header1 ?></span>
